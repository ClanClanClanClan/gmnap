...
Given a mathematician like **Terence Tao**:
...
3. **Curated genealogy JSON** (`data/genealogy_enrichment.json`, 6172
   entries). Loaded once per process into the `GenealogyLookup`
