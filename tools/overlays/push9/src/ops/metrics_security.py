...
HASHCASH_VERIFIED = Counter("gmnap_hashcash_verified_total", "Valid Hashcash stamps verified")
JWT_VERIFIED = Counter("gmnap_jwt_verified_total", "Valid JWTs verified")
SECURITY_EVENT = Counter("gmnap_security_events_total", "Security events by type", ["event"])
