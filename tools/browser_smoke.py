...
def scenario_rapid_fire(page: Page, base: str):
    ...
    names = [
        ...
        "Tao, T.", "Erdős, Paul", "Mirzakhani, Maryam",
        "Kolmogorov, Andrey", "Ramanujan, Srinivasa", "Wiles, A.",
        "Perelman, G.", "Turing, Alan", "von Neumann, John",
        "Chern, Shiing-Shen", "Grothendieck, Alexander", "Serre, J.-P.",
