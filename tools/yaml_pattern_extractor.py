...
class YAMLPatternExtractor:
    def __init__(self, docs_path="/Users/dylanpossamai/Library/CloudStorage/Dropbox/Work/Maths/gmnap/docs"):
    ...
    def extract_hungarian_patterns(self):
        ...
        key_patterns = [s for s in hungarian_surnames if 'rényi' in s or 'renyi' in s or 'erdős' in s or 'erdos' in s]
        if key_patterns:
    ...
    def extract_korean_patterns(self):
        ...
        key_patterns = [s for s in korean_surnames if any(target in s for target in ['lee', 'choi', 'cho', 'jang', 'ahn', 'baek'])]
        if key_patterns:
    ...
    def extract_slavic_patterns(self):
        ...
        key_patterns = [s for s in slavic_surnames if any(target in s for target in ['hájek', 'novák', 'wójcik', 'banach', 'sierpiński'])]
        if key_patterns:
