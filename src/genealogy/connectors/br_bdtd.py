"""
genealogy/connectors/br_bdtd.py
OAI-PMH harvester for Brazilian BDTD (Biblioteca Digital Brasileira de Teses e Dissertações).
Based on FR connector, adapted for Portuguese metadata.
"""
...
def parse_dc(raw_xml: str) -> Dict[str, Any]:
    ...
    # Portuguese institution keywords
