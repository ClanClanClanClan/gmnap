...
from src.core.security_patterns import (
    ADDITIONAL_PATTERNS,
    DANGEROUS_PATTERNS,
    EXTENDED_PATTERNS,
...
class SecurityValidator:
    ...
    def __init__(self):
        # Pattern tables live in src.core.security_patterns (R46 split);
        # per-instance list() copies keep the prior mutability semantics.
        self.dangerous_patterns = list(DANGEROUS_PATTERNS)

        # Additional patterns for comprehensive coverage
        self.additional_patterns = list(ADDITIONAL_PATTERNS)

        # Compile all patterns for performance
        all_patterns = self.dangerous_patterns + self.additional_patterns

        # Additional comprehensive security patterns
        self.extended_patterns = list(EXTENDED_PATTERNS)
