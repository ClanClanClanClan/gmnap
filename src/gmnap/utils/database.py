...
class DatabaseManager:
    ...
    def _initialize_database(self):
        ...
        with self._init_lock:
            ...
            if (DUCKDB_AVAILABLE and 
                self.config.use_duckdb and 
                memory_available >= self.config.memory_threshold_gb):
                try:
    ...
    def _initialize_sqlite(self):
        ...
        self.connection.execute(f"PRAGMA cache_size={self.config.cache_size_mb * 1024 // 4}")  # 4KB pages
    ...
    def _get_global_ids_for_surname(self, surname: str, birth_decade: Optional[int], country_code: Optional[str]) -> List[str]:
    ...
    def _determine_region_code(self, data: Dict[str, Any]) -> str:
        ...
        region_mapping = {
            "US": "A1", "GB": "A1", "CA": "A1", "AU": "A1", "NZ": "A1",
            "FR": "A2", "DE": "A2", "IT": "A2", "ES": "A2", "PT": "A2",
            "RU": "B1", "UA": "B1", "BY": "B1",
            "CN": "E1", "JP": "E3", "KR": "E4"
        }
