...
class D1_SouthAsiaHindiBelt(RegionSpec):
    ...
    def __init__(self):
        ...
        self.honorifics = {
            # Hindi honorifics
            "श्री", "श्रीमती", "श्रीमान", "सुश्री", "कुमारी", "कुमार",
            "Shri", "Shree", "Sri", "Smt", "Smt.", "Shrimati", "Kumari", "Kumar",
            
            # Religious/professional titles
            "पंडित", "पं.", "Pandit", "Pt", "Pt.",
            "डॉ.", "डॉक्टर", "Dr", "Dr.", "Doctor",
            "प्रो.", "प्रोफेसर", "Prof", "Prof.", "Professor",
            "इंजीनियर", "Er", "Er.", "Engineer",
            "गुरु", "Guru", "स्वामी", "Swami", "महात्मा", "Mahatma",
            "बाबू", "Babu", "मास्टर", "Master", "जी", "Ji",
            
            # Caste/community titles
            "ठाकुर", "Thakur", "चौधरी", "Chaudhary", "Chaudhuri",
            "राय", "राव", "Rai", "Rao", "Roy",
            "सिंह", "Singh",  # Often used as title
            "वर्मा", "Verma", "शर्मा", "Sharma",  # Brahmin indicators
            
            # Sikh titles
            "सरदार", "Sardar", "S.", "गुरबचन", "Gurbachan",
            "भाई", "Bhai",
            
            # Muslim titles (in Hindi belt)
            "हाजी", "Haji", "मौलवी", "Maulvi", "मौलाना", "Maulana",
            "खान", "Khan", "बेगम", "Begum", "बीबी", "Bibi"
        }
        
        # Name suffixes that might be caste/community indicators
        self.caste_indicators = {
            # Brahmin
            "शर्मा", "Sharma", "पांडे", "Pandey", "मिश्र", "Mishra", "मिश्रा", "Misra",
            "त्रिपाठी", "Tripathi", "द्विवेदी", "Dwivedi", "चतुर्वेदी", "Chaturvedi",
            "शुक्ल", "Shukla", "शुक्ला", "Shukla", "अग्निहोत्री", "Agnihotri",
            
            # Kshatriya
            "सिंह", "Singh", "राणा", "Rana", "राज", "Raj", "ठाकुर", "Thakur",
            "चौहान", "Chauhan", "तोमर", "Tomar", "राठौर", "Rathore",
            
            # Vaishya
            "गुप्ता", "Gupta", "अग्रवाल", "Agrawal", "अग्रवाल", "Agarwal",
            "बंसल", "Bansal", "गोयल", "Goyal", "जैन", "Jain",
            
            # Other communities
            "यादव", "Yadav", "पटेल", "Patel", "कुमार", "Kumar",
            "वर्मा", "Verma", "जायसवाल", "Jaiswal", "सिन्हा", "Sinha",
            "प्रसाद", "Prasad", "राम", "Ram", "लाल", "Lal"
        }
        
        # Common name patterns
        self.name_particles = {
            "कुमार", "Kumar",  # Often middle name
            "चंद", "Chand", "चन्द", "Chandra",
            "प्रसाद", "Prasad", "प्रकाश", "Prakash",
            "देव", "Dev", "देवी", "Devi",
            "लाल", "Lal", "राम", "Ram",
            "नाथ", "Nath", "दास", "Das",
            "पाल", "Pal", "बहादुर", "Bahadur"
        }
        ...
        self.common_given_names = {
            ...
            "अजय", "Ajay", "विजय", "Vijay", "संजय", "Sanjay",
            "राज", "Raj", "राजेश", "Rajesh", "सुरेश", "Suresh",
            "मोहन", "Mohan", "सोहन", "Sohan", "रोहन", "Rohan",
            "अमित", "Amit", "सुमित", "Sumit", "अनिल", "Anil",
            
            # Female names
            "सीता", "Sita", "गीता", "Gita", "राधा", "Radha",
            "प्रिया", "Priya", "पूजा", "Pooja", "अनीता", "Anita",
            "सुनीता", "Sunita", "कविता", "Kavita", "ममता", "Mamta",
            "रेखा", "Rekha", "सुधा", "Sudha", "आशा", "Asha"
        }
    ...
    def _is_common_middle_name(self, word: str) -> bool:
        ...
        return word in self.name_particles or word in ["Kumar", "कुमार", "Chand", "चंद", "Prasad", "प्रसाद"]
    ...
    def _romanize_name(self, name: str) -> str:
        ...
        common_names_map = {
            "राम": "Ram", "श्याम": "Shyam", "कृष्ण": "Krishna",
            "सिंह": "Singh", "शर्मा": "Sharma", "गुप्ता": "Gupta",
            "कुमार": "Kumar", "प्रसाद": "Prasad", "वर्मा": "Verma"
        }
    ...
    def validate(self, entry: Dict[str, Any]) -> None:
        """Validate entry according to D1 rules."""
        ...
        # If CanonicalNative exists, it should contain Devanagari
        if canonical_native:
            if not self._is_devanagari(canonical_native) and not self._is_mixed_script(canonical_native):
                raise RegionRuleError(f"CanonicalNative should contain Devanagari: {canonical_native}")
