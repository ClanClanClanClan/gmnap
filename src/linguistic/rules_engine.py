...
class LinguisticRulesEngine:
    ...
    def apply_rules(self, text: str, rule_types: List[RuleType] = None, 
                   region: str = None, script: str = None) -> Tuple[str, List[str]]:
        """
    ...
    def normalize_name(self, name: str, region: str = None) -> Dict[str, Any]:
        ...
        normalized, norm_rules = self.apply_rules(
            name, 
            rule_types=[RuleType.NORMALIZATION], 
            region=region
        )
        ...
        standardized, std_rules = self.apply_rules(
            normalized,
            rule_types=[RuleType.STANDARDIZATION],
            region=region
        )
        ...
        _, val_rules = self.apply_rules(
            standardized,
            rule_types=[RuleType.VALIDATION],
            region=region
        )
