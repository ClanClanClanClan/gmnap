...
class RegionManager:
    ...
    def _init_script_mappings(self):
        ...
        self._script_to_regions = {
            "Latin": [
                r
                for r in ["A1", "A2", "A3", "A4", "A5", "B2", "G1", "F1", "F2", "F4", "R0"]
    ...
    def _detect_by_overlay(
        self, entry: Dict[str, Any], country_codes: List[str]
        ...
        for country in country_codes:
            ...
            if country == "IN":
                ...
                if any(
                    ...
                    w in inst_lower
                    for w in ["kolkata", "calcutta", "bengal", "jadavpur", "presidency"]
                ):
                ...
                if any(
                    w in inst_lower
                    for w in ["genève", "geneva", "lausanne", "fribourg", "neuchâtel"]
                ):
