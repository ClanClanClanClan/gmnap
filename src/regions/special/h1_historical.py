"""
Historical (≤1850) (H1) regional processor.

Implements Pre-modern Latinized names and epithets
"""
...
class H1Historical(RegionSpec):
    """Handler for H1 - Historical (≤1850)."""

    def __init__(self):
        super().__init__(
            code="H1", yaml_files=[], scripts=["Latin"]  # TODO: Add actual YAML files,
        )

    def clean(self, name: str) -> str:
        """Clean and normalize Historical (≤1850) name."""
    ...
    def order_key(self, entry: Dict[str, Any]) -> str:
        """Generate sort key for H1 names."""
        canonical = entry.get("CanonicalLatin", "")
