"""
Lusophone Africa (F4) regional processor.

Implements Portuguese colonial naming patterns in Africa
"""
...
class F4LusophoneAfrica(RegionSpec):
    """Handler for F4 - Lusophone Africa."""

    def __init__(self):
        super().__init__(
            code="F4", yaml_files=[], scripts=["Latin"]  # TODO: Add actual YAML files,
        )

    def clean(self, name: str) -> str:
        """Clean and normalize Lusophone Africa name."""
    ...
    def order_key(self, entry: Dict[str, Any]) -> str:
        """Generate sort key for F4 names."""
        canonical = entry.get("CanonicalLatin", "")
