"""
SSA - Anglophone (F2) regional processor.

Implements Sub-Saharan Africa with English naming patterns
"""
...
class F2SSAAnglophone(RegionSpec):
    """Handler for F2 - SSA - Anglophone."""

    def __init__(self):
        super().__init__(
            code="F2", yaml_files=[], scripts=["Latin"]  # TODO: Add actual YAML files,
        )

    def clean(self, name: str) -> str:
        """Clean and normalize SSA - Anglophone name."""
