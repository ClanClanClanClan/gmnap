...
class RegionalValidationEngine:
    ...
    def _validate_slavic_patronymic(
        self, entry: Dict[str, Any], rule: RegionalValidationRule
    ) -> Optional[ValidationResult]:
    ...
    def _validate_central_asian_script(
        self, entry: Dict[str, Any], rule: RegionalValidationRule
    ) -> Optional[ValidationResult]:
    ...
    def _validate_dravidian_initial(
        self, entry: Dict[str, Any], rule: RegionalValidationRule
    ) -> Optional[ValidationResult]:
    ...
    def _validate_sea_monosyllabic(
        self, entry: Dict[str, Any], rule: RegionalValidationRule
    ) -> Optional[ValidationResult]:
    ...
    def _validate_francophone_particle(
        self, entry: Dict[str, Any], rule: RegionalValidationRule
    ) -> Optional[ValidationResult]:
    ...
    def _validate_indigenous_naming(
        self, entry: Dict[str, Any], rule: RegionalValidationRule
    ) -> Optional[ValidationResult]:
