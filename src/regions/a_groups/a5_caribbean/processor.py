...
class A5CaribbeanProcessor(RegionSpec):
    ...
    def __init__(self):
        ...
        self.creole_particles = {
            # French-based Creole
            "d'", "D'", "l'", "L'",  # contractions
            "di", "Di",              # "of" in some Creoles
            "la", "La",              # definite article
            "ti", "Ti",              # "petit/little" (common nickname prefix)
            "man", "Man",            # Creole form
            # Less common but present
            "zot", "Zot",            # "their/them" in some Creoles
            "mo", "Mo",              # "my" in some Creoles
        }
        ...
        self.dutch_particles = {
            ...
            "de", "der", "den", "ter", "te", "ten"
        }
        
        # Common Caribbean surname patterns
        self.caribbean_surnames = {
            # French Caribbean
            "Césaire", "Fanon", "Bissainthe", "Desvarieux", "Kassav",
            "Théodore", "Baptiste", "Saint-Prix", "Sainte-Rose",
            # Dutch Caribbean
            "Martina", "Croes", "Tromp", "Winklaar", "Eman",
            # African-origin
            "Toussaint", "Dessalines", "Christophe", "Pétion",
            # Common religious-origin
            "Saint-Jean", "Saint-Louis", "Saint-Pierre", "Emmanuel",
            # Plantation-era
            "Beauregard", "Bellegarde", "Delafosse", "Duvalier"
        }
        ...
        self.caribbean_first_names = {
            ...
            "Thérèse", "Marguerite", "Céleste", "Émilie",
            # Diminutives/nicknames
            "Ti-Jean", "Ti-Pierre", "Man-Marie",
            # Dutch influence
            "Johannes", "Willem", "Hendrik", "Cornelis",
            # African-influenced
            "Ayizan", "Erzulie", "Agwe", "Legba",
            # Modern Caribbean
            "Eddy", "Jimmy", "Claude", "Serge"
        }
        
        # Titles to remove
        self.titles = {
            # French
            "M", "M.", "Mme", "Mlle", "Dr", "Dr.", "Me",
            # Dutch
            "Dhr", "Dhr.", "Mw", "Mw.", "Mej", "Mej.",
            # English (common due to tourism/international business)
            "Mr", "Mr.", "Mrs", "Mrs.", "Ms", "Ms.", "Miss",
            # Religious
            "Père", "Soeur", "Fr", "Fr.", "Sr", "Sr."
        }
    ...
    def _extract_components(self, name: str) -> Dict[str, Any]:
        ...
        while i < len(family_words):
            ...
            if (word_lower in self.french_particles or 
                word_lower in self.dutch_particles or
                word_lower in self.creole_particles):
        ...
        if any(part.startswith("Saint-") or part.startswith("Sainte-") 
               for part in family_words):
            components["has_saint_compound"] = True
        
        # Check for African-influenced patterns
        if has_creole or any(word in ["Toussaint", "Dessalines", "Christophe"] 
    ...
    def _detect_french_influence(self, name: str) -> bool:
        ...
        french_surnames = {"Baptiste", "Césaire", "Théodore", "François", 
                          "Saint-Jean", "Saint-Louis", "Saint-Pierre"}
