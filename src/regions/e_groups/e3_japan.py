...
class E3_Japan(RegionSpec):
    ...
    def __init__(self):
        ...
        self.common_surnames = {
            ...
            "後藤", "岡田", "長谷川", "石井", "村上", "近藤", "坂本", "遠藤", "青木", "藤井",
        ...
        self.titles = {
            ...
            "教授", "准教授", "助教授", "講師", "助手", "研究員", "博士", "修士", "学士",
            "先生", "医師", "弁護士", "技師", "主任", "課長", "部長", "社長", "会長",
        ...
        self.common_elements = {
            ...
            # Given names
            "太郎": "Taro", "次郎": "Jiro", "三郎": "Saburo", "四郎": "Shiro",
            "花子": "Hanako", "美子": "Yoshiko", "恵子": "Keiko", "由美": "Yumi",
            "健一": "Kenichi", "誠": "Makoto", "博": "Hiroshi", "明": "Akira",
            "美": "Mi", "子": "Ko", "郎": "Ro", "一": "Ichi", "二": "Ni"
        }
