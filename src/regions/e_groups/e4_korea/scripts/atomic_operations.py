...
class AtomicFSTRebuild:
    ...
    def rebuild(self):
        ...
        expected_files = [
            "rom2han_surname.fst", "rom2han_given.fst", "rom2han_multi.fst",
            "han2rom_surname.fst", "han2rom_given.fst", "han2rom_multi.fst"
        ]
    ...
    with ProductionLock():
        try:
            ...
            raise ProductionError(
                ...
                exit_code=4,
                remediation=["Check system resources", "Verify file permissions", "Review error logs"]
            )
...
def safe_add_weight(weight_line, test_mode=False):
    ...
    try:
        ...
        print(f"✅ Weight format validated: {validated['hangul']} → {validated['roman']} ({validated['weight']})")
    ...
    with production_operation("Safe weight addition"):
        ...
        try:
            ...
            raise ProductionError(
                ...
                exit_code=6,
                remediation=["Check system logs", "Verify file permissions", "Contact system administrator"]
            )
