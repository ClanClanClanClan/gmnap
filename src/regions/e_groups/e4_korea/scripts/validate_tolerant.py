...
EQUIVALENT_PAIRS = [
    ...
    ('jung', 'jeong'), ('jung', 'chung'), ('jeong', 'chung'),
    ('jong', 'jung'), ('jong', 'jeong'), ('jong', 'chong'),
    
    # Lee/Yi/Rhee variants  
    ('lee', 'yi'), ('lee', 'rhee'), ('lee', 'i'), ('yi', 'rhee'),
    ('lee', 'li'), ('yi', 'li'), ('rhee', 'li'),
    
    # Park/Pak/Bak variants
    ('park', 'pak'), ('park', 'bak'), ('pak', 'bak'),
    ...
    # Ryu/Yoo/Yu
    ('ryu', 'yoo'), ('ryu', 'yu'), ('yoo', 'yu'),
    
    # Oh/O
    ('oh', 'o'),
    
    # Common given name variants
    ('hyun', 'hyeon'), ('hyun', 'hyon'),
    ('yun', 'yoon'), ('yun', 'youn'),
    ('jun', 'joon'),
    ('uk', 'ook'), ('uk', 'wook'),
    ('suk', 'seok'), ('suk', 'sook'),
    ('kyun', 'gyun'), ('kyun', 'kyeon'),
    ('min', 'meen'),
