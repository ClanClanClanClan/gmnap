...
def systematic_improvement_demo():
    ...
    print(f"After safe fixes: {current_independent + estimated_improvement}/{total_independent} = {new_success_rate:.2f}%")
    print(f"Improvement: +{estimated_improvement} cases (+{estimated_improvement/total_independent*100:.2f}%)")
...
def apply_safe_fixes_example(fixes):
    ...
    print(f"1. echo '# Safe additions from systematic improvement' >> resources/rr_syllable_map.csv")
