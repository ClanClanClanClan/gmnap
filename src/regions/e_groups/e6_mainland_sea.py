"""
Mainland SEA (E6) regional processor.

Implements Thai RTGS, Khmer UNGEGN, Lao MOICT romanization
"""
...
class E6MainlandSEA(RegionSpec):
    ...
    def clean(self, name: str) -> str:
        """Clean and normalize Mainland SEA name."""
    ...
    def augment(self, entry: Dict[str, Any]) -> None:
        """Augment entry with E6-specific data."""
        # Add region code
    ...
    def order_key(self, entry: Dict[str, Any]) -> str:
        """Generate sort key for E6 names."""
        canonical = entry.get("CanonicalLatin", "")
