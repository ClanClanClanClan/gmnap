...
Implements Sinhala script with UN 2003 transliteration
"""
...
class D5Sinhala(RegionSpec):
    """Handler for D5 - Sinhala."""
    
    def __init__(self):
        super().__init__(
            code="D5",
            yaml_files=[],  # TODO: Add actual YAML files,
            scripts=['Sinhala', 'Latin']
        )
        
    def clean(self, name: str) -> str:
        """Clean and normalize Sinhala name."""
