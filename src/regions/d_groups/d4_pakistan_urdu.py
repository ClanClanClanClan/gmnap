"""
Pakistan & Urdu (D4) regional processor.

Implements Urdu script with Arabic loan patterns
"""
...
class D4PakistanUrdu(RegionSpec):
    ...
    def clean(self, name: str) -> str:
        """Clean and normalize Pakistan & Urdu name."""
    ...
    def order_key(self, entry: Dict[str, Any]) -> str:
        """Generate sort key for D4 names."""
        canonical = entry.get("CanonicalLatin", "")
