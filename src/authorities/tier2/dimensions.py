"""
Dimensions authority source (Tier 2).

Implements GMNAP v7 authority fetching for Dimensions.
...
class DimensionsFetcher:
    """
    Dimensions authority source fetcher.
    ...
    def _get_base_url(self) -> str:
        """Get API base URL for Dimensions."""
        base_urls = {
        ...
        return base_urls.get("Dimensions", "https://api.example.com/")
