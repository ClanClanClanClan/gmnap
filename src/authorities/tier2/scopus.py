"""
Scopus authority source (Tier 2).

Implements GMNAP v7 authority fetching for Scopus.
Licence: Elsevier
Daily Quota: 20000
"""
...
class ScopusFetcher:
    ...
    def _get_base_url(self) -> str:
        ...
        return base_urls.get("Scopus", "https://api.example.com/")
