"""
zbMATH Open authority source (Tier 1).

Implements GMNAP v7 authority fetching for zbMATH Open.
Licence: CC-BY
Daily Quota: 200
"""
...
class zbMATHOpenFetcher:
    """
    zbMATH Open authority source fetcher.
    ...
    def _get_base_url(self) -> str:
        """Get API base URL for zbMATH Open."""
        base_urls = {
        ...
        return base_urls.get("zbMATH Open", "https://api.example.com/")
