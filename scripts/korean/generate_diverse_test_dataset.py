...
def generate_diverse_dataset():
    ...
    politicians = [
        ...
        (
            ...
            ["Ban", "Pan"],
            [["Ki", "Gi"], ["Moon", "Mun"]],
            "Politics (Former UN Secretary-General)",
        ),
        (
            "Han_DukSoo",
            "한",
    ...
    historical = [
        ...
        (
            ...
            ["Se"],
            [["Jong"]],
            "Historical (King Sejong the Great)",
            ["KR"],
        ),
        (
            "Shin_SaImDang",
        ...
        (
            ...
            ["Kim", "Gim"],
            [["Gu", "Ku", "Koo"]],
            "Historical (Independence activist)",
        ),
        (
            "An_JungGeun",
            "안",
