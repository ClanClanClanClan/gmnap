...
incorrect_mappings = [
    ...
    # Pass A: Remove base table duplicates that steal SURNAME_0 priority
    ("김", "gim"),  # Conflicts with variant_map.csv SURNAME_0
    ("박", "pak"),  # Conflicts with variant_map.csv SURNAME_0
    ("박", "bak"),  # Conflicts with variant_map.csv SURNAME_0
    ("이", "i"),  # Conflicts with variant_map.csv SURNAME_0
    ("최", "choe"),  # Conflicts with variant_map.csv SURNAME_0
    ("정", "jeong"),  # Conflicts with variant_map.csv SURNAME_0
    ("임", "im"),  # Conflicts with variant_map.csv SURNAME_0
    ("오", "o"),  # Conflicts with variant_map.csv SURNAME_0
    # Pass C: Remove toxic rows
    ("팎", "pak"),  # Erroneous character
    ("퀘온", "kweon"),  # Erroneous character
    ("허", "huh"),  # Duplicate of 허,heo - causes confusion
    ("주네", "june"),  # Erroneous transliteration
]
