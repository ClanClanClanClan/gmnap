            ...
            if adapter:
                ...
                try:
                    if adapter_name == "Crossref_Thesis":
                        result = adapter.query(author="Andrew Wiles")
...
def test_crossref_v7():
    ...
    try:
        ...
        print("  Searching for 'Andrew Wiles'...")
        result = fetcher.search_author("Andrew Wiles", limit=3)
