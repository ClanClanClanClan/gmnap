...
def generate_stats():
    ...
    print("=" * 50)
    print(
        f"Regions: {stats['regions']['implemented']}/{stats['regions']['total']} ({stats['compliance']['regions']}%)"
    )
    print(
        f"Authority Sources: {stats['authorities']['implemented']}/{stats['authorities']['total']} ({stats['compliance']['authorities']}%)"
    )
    print(
        f"Linguistic Rules: {stats['linguistic_rules']['implemented']}/{stats['linguistic_rules']['total']} ({stats['compliance']['linguistic_rules']}%)"
    )
