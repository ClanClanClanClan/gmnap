...
MISSING_REGIONS = [
    ...
    },
    {
        ...
        "territories": ["BJ", "BF", "CM", "CF", "CG", "CI", "DJ", "GA", "GN", "ML", "NE", "SN", "TG", "TD", "KM", "SC", "MG", "BI"],
        "group": "f_groups"
    },
    {
        "code": "F2",
        ...
        "territories": ["GH", "NG", "KE", "UG", "TZ", "ZW", "ZM", "MW", "GM", "LR", "SL", "BW", "LS", "NA", "RW", "SZ", "MU", "SS"],
        "group": "f_groups"
    },
    {
        "code": "F3",
...
def update_pipeline_imports():
    ...
    for region in MISSING_REGIONS:
        module_name = region['code'].lower() + '_' + region['full_name'].lower().replace(' & ', '_').replace(' - ', '_').replace(' ', '_')
