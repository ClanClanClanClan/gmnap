...
def run_performance_tests(yaml_path):
    ...
    print(f"  Throughput: {st['throughput_per_sec']:.0f}/sec (target: >{targets['throughput_per_sec']}/sec)")
    ...
    print(f"  Throughput: {mt['throughput_per_sec']:.0f}/sec (target: >{targets['throughput_per_sec']}/sec)")
...
if __name__ == "__main__":
    ...
    parser.add_argument("-i", "--input", default="data/korean.yaml", 
