...
def fix_korean_boost_placement():
    ...
    korean_pattern_match = re.search(r'(has_korean_pattern = any\(name_lower\.startswith\(surname \+ \',\'\) or name_lower\.startswith\(surname \+ \' \'\) for surname in korean_surnames\))', content)
