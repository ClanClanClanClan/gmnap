...
class TestResourceMonitor:
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            "duration_seconds": self.resource_data[-1]["timestamp"] - self.resource_data[0]["timestamp"],
            ...
            for test in data.get("tests", []):
                if test.get("outcome") == "failed":
                    failures.append({
                        ...
                        "failure_message": test.get("call", {}).get("longrepr", "Unknown failure"),
    ...
    def _check_quality_gates(self) -> Dict[str, Any]:
        ...
        gates = {
            ...
            "no_invariant_violations": {
                ...
                "actual": len([r for r in self.test_results if r["category"] == "invariant_verification" and r["status"] == "FAILED"]),
                "passed": len([r for r in self.test_results if r["category"] == "invariant_verification" and r["status"] == "FAILED"]) == 0
            }
        }
    ...
    def _generate_human_report(self, report: Dict[str, Any]):
        ...
        with open(report_file, 'w') as f:
            ...
            for gate_name, gate_data in report['quality_gates'].items():
                ...
                f.write(f"  {gate_name}: {status} (actual: {gate_data['actual']}, threshold: {gate_data['threshold']})\n")
            f.write("\n")
...
def main():
    ...
    print(f"Tests: {report['test_summary']['total_tests']} total, {report['test_summary']['passed']} passed, {report['test_summary']['failed']} failed")
