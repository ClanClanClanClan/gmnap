...
class TestLongRunningStress:
    ...
    def test_continuous_globalid_generation(self):
        ...
        assert summary["memory_peak_mb"] < summary["memory_avg_mb"] * 2, \
    ...
    def test_sustained_unicode_processing(self):
        ...
        assert summary["memory_peak_mb"] < 1024, f"Memory exceeded limit: {summary['memory_peak_mb']}MB"
...
class TestDatabaseStressEndurance:
    ...
    def test_database_concurrent_stress(self):
        ...
        assert total_successful > num_workers * operations_per_worker * 0.9, \
