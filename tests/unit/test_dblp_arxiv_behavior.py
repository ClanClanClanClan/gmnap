...
def test_arxiv_names_similar_variants(arxiv):
    assert arxiv._names_similar("Terence Tao", "Terence C. Tao")
    assert arxiv._names_similar("Terence Tao", "terence tao")
    assert not arxiv._names_similar("Terence Tao", "Emmy Noether")
