...
REGION_TEST_CASES = [
    ...
    ("Nagy, Imre", ["HU"], "A2", "Most common Hungarian surname"),
    ("Toth, Istvan", ["HU"], "A2", "Common Hungarian surname"),
    ("Kovacs, Zoltan", ["HU"], "A2", "Common Hungarian surname"),
    ("Erdos, Pal", ["HU"], "A2", "Hungarian mathematician (ASCII)"),
...
DIACRITICS_CASES = [
    ...
    ("Erdos, Pal", ["HU"], "A2", "Hungarian o-double-acute (ASCII)"),
...
async def test_pipeline_stage2_wires_detection_fields():
    ...
    entries = [
        ...
        {"CanonicalLatin": "Kim, M.", "CountryCodes": ["KR"]},
    ]
...
MESSY_DATA_CASES = [
    ...
    ("Kim, M. III", ["KR"], "E4", "With Roman numeral suffix"),
    ...
    ("Kim, M. (Korean)", ["KR"], "E4", "Parenthetical annotation"),
]
...
EXPANDED_NO_CC_CASES = [
    ...
    ("Almeida, J.", "A2", "Portuguese surname (PT→A2)"),
...
CITATION_CASES = [
    ...
    ("von Neumann, J.", ["HU"], "A2", "German particle + initial"),
    ...
    ("P. Erdos", ["HU"], "A2", "Hungarian initial-first"),
