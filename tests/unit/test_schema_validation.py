    ...
    def test_valid_complete_entry(self):
        ...
        entry = {
            ...
            "Variants": {
                ...
                "Synthesised": [
                    {"str": "Garcia, Jose", "type": "ascii-lossy"}
                ]
            },
            ...
            "NameEvents": [
                {"type": "marriage", "year": 2010, "from": "José García", "to": "José García Martín"}
            ],
