...
TEST_CONFIG = {
    ...
    "test_mathematicians": [
        {"GlobalID": "test-tao", "CanonicalLatin": "Tao, T.", "CanonicalNative": None},
        {
        ...
        {"GlobalID": "test-wiles", "CanonicalLatin": "Wiles, A.", "CanonicalNative": None},
    ],
}
    ...
    async def test_authority_apis(self) -> Dict[str, Dict[str, Any]]:
        ...
        try:
            ...
            async with CrossrefAPI() as api:
                results = await api.search_author("T. Tao")
        ...
        try:
            ...
            async with OpenAlexAPI() as api:
                results = await api.search_authors("T. Tao")
        ...
        try:
            ...
            async with MathGenealogyAPI() as api:
                results = await api.search_by_name("A. Wiles")
