                ...
                with patch.object(
                    ...
                    with patch.object(
                        ...
                        with patch.object(
                            ...
                            side_effect=lambda: mock_stage("stage_4"),
                        ):
                            with patch.object(
                                pipeline,
                                "_stage_5_collision_analytics",
                                side_effect=lambda: mock_stage("stage_5"),
                            ):
                                with patch.object(
                                    pipeline,
                                    "_stage_6_tag_short_forms",
                                    side_effect=lambda: mock_stage("stage_6"),
                                ):
                                    with patch.object(
                                        pipeline,
                                        "_stage_7_global_validate",
                                        side_effect=lambda: mock_stage("stage_7"),
                                    ):
                                        with patch.object(
                                            pipeline,
                                            "_stage_8_write_diff",
                                            side_effect=lambda: mock_stage("stage_8"),
                                        ):
                                            with patch.object(
                                                pipeline,
                                                "_stage_9_report",
