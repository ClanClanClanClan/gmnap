...
| Shestakov, Ivan | G1 (Brazil) | B1 (Slavic) | Russian name in Brazil. Correct name-origin. |
| Yuanhua, Sun | A1 (Ming dynasty→US) | E1 (Chinese) | Chinese name. Correct name-origin. |
| Cordeiro, Gauss Moutinho | G1 (Brazil) | A2 (Germanic) | Portuguese surname. Correct for A2 (PT→A2). |
