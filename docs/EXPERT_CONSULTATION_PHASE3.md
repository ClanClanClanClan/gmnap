...
| Tao, T. | E1 | E1 | SINOPHONE | surname |
| **Wiles, A.** | **A1** | **R0** | **ANGLO_SPHERE** | name-abstain |
| Grothendieck, Alexander | A2 | A2 | GERMANIC_WESTERN | surname |
| Serre, J.-P. | A2 | A2 | GERMANIC_WESTERN | surname |
| **Perelman, G.** | **B1** | **R0** | **None** | name-abstain |
...
| Wiles, A. | R0 | ANGLO_SPHERE | "Andrew" matches A1 given name |
