...
| Metric | Raw | Train-set isotonic | 5-fold CV (held-out) |
|---|---:|---:|---:|
| Eligible entries (leaf-mode) | 843 | 843 | 843 |
| Predictions emitted | 654 | 654 | 654 |
| Abstentions (R0 / None) | 189 | 189 | 189 |
| Brier score | **0.1378** | **0.1142** | **0.1149** |
| Expected Calibration Error (ECE) | **0.1860** | **0.0000** | **0.0039** |
...
same set, ECE drops to **0.0000** (2 knots fitted,
