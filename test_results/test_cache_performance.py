...
def test_cache_performance():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        stage4_time1 = result1.stage_metrics["stage_4"].end_time - result1.stage_metrics["stage_4"].start_time
        ...
        stage4_time2 = result2.stage_metrics["stage_4"].end_time - result2.stage_metrics["stage_4"].start_time
        ...
        print("-" * 50)
        improvement = (stage4_time1.total_seconds() - stage4_time2.total_seconds()) / stage4_time1.total_seconds()
